...
--
ALTER TABLE `track`
  MODIFY `TrackId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2884;
...
SELECT * FROM track
WHERE Bytes BETWEEN 4000000 AND 5000000;
...
SELECT * FROM genre
WHERE Name IN ('Pop', 'Jazz', 'Soundtrack');
...
SELECT * FROM artist
WHERE Name NOT IN ('Aerosmith', 'Alice In Chains', 'Accept');
